...
elseif version > 20000 and version < 30000 then
    RXP_.version = "TBC"
elseif version > 30000 and version < 90000 then
    RXP_.version = "RETAIL"
end
...
questFrame:RegisterEvent("UNIT_QUEST_LOG_CHANGED")
questFrame:RegisterEvent("QUEST_WATCH_LIST_CHANGED")
...
function RXP_.UpdateQuestButton(index)
    ...
    hooksecurefunc("SetSelectedQuest", RXP_.UpdateQuestButton )
